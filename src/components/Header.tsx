      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
            ...
            {isAuthenticated ? (
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className="text-gray-700 hover:text-black px-3 py-2 text-sm font-medium transition-colors cursor-pointer"
                >
                  Sign Out
                </button>
              </div>
          ...
          <div className="md:hidden">
            <button className="text-gray-700 hover:text-black p-2 cursor-pointer">
